...
namespace rchia
{
    public sealed class Worker : rchia.Commands.IConsoleMessage
    {
        ...
        public async Task<int> DoWorkAsync(string msg, Func<StatusContext, Task> work)
        {
            try
            {
