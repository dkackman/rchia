...
dotnet publish ./rchia/rchia.csproj --configuration Release --framework net5.0 --output publish/standalone/linux-arm64 --self-contained True --runtime linux-arm64 --verbosity Normal /property:PublishTrimmed=True /property:PublishSingleFile=True /property:IncludeNativeLibrariesForSelfExtract=True /property:DebugType=None /property:DebugSymbols=False
...
dotnet publish ./rchia/rchia.csproj --configuration Release --framework net5.0 --output publish/singlefile/linux-arm64 --self-contained False --runtime linux-arm64 --verbosity Normal /property:PublishSingleFile=True /property:IncludeNativeLibrariesForSelfExtract=True /property:DebugType=None /property:DebugSymbols=False
...
dotnet publish ./rchia/rchia.csproj --configuration Release --framework net5.0 --output publish/files/linux-arm64 --self-contained False --runtime linux-arm64 --verbosity Normal /property:PublishSingleFile=False /property:DebugType=None /property:DebugSymbols=False
dotnet publish ./rchia/rchia.csproj --configuration Release --framework net5.0 --output publish/files/any-cpu --self-contained False --runtime linux-arm64 --verbosity Normal /property:PublishSingleFile=False /property:DebugType=None /property:DebugSymbols=False
